...
LOCAL_TERMS = {
    ...
    "bairros_de_manaus": [
        "adrianópolis", "adrianopolis", "aleixo", "alvorada",
        "armando mendes", "betânia", "betania", "cachoeirinha", "centro",
        "chapada", "cidade de deus", "cidade nova",
        "colônia antônio aleixo", "colonia antonio aleixo",
        "colônia oliveira machado", "colonia oliveira machado",
        "compensa", "coroado", "crespo", "da paz", "dom pedro",
        "educandos", "flores", "gilberto mestrinho", "glória", "gloria",
        ...
        "parque 10", "parque dez", "petrópolis", "petropolis", "planalto",
        "ponta negra", "praça 14", "praca 14", "praça 14 de janeiro",
        "praca 14 de janeiro", "presidente vargas", "puraquequara",
        "raiz", "redenção", "redencao", "santa etelvina", "santa luzia",
        "santo agostinho", "santo antônio", "santo antonio",
        "são francisco", "sao francisco", "são geraldo", "sao geraldo",
        "são jorge", "sao jorge", "são josé", "sao jose",
    ...
    "veiculos_locais": [
        "a crítica", "a critica", "tv a crítica", "tv a critica",
        "acrítica", "acritica", "rede amazônica", "rede amazonica",
        "g1 amazonas", "em tempo", "d24am", "diário do amazonas",
        "diario do amazonas", "jornal do commercio",
        "portal do holanda", "blog do holanda",
        "portal marcos santos", "fato amazônico", "fato amazonico",
        "amazonas atual", "amazonas 1", "portal do zacarias",
        "cm7", "cm7 brasil", "portal norte", "bnc amazonas",
        "correio da amazônia", "correio da amazonia",
        "radar amazônico", "radar amazonico", "rio de notícias",
        "rios de notícias", "rios de noticias",
        "portal manaus alerta", "chumbo grosso manaus",
        "portal da floresta", "portal único", "portal unico",
        "tribuna do amazonas", "tribuna de manaus", "norte em foco",
        "portal o poder", "realtime", "vocativo", "manaus 360",
        "am post", "portal regional am", "portaltambaqui",
        "portal tambaqui", "canal 92 am", "canal92am", "sgc",
        "portal r5", "portal am24h", "portal manaus", "comunica am",
        "portal amazon online", "no ar portal",
        "menezes virtual eye", "blog do pávulo", "blog do pavulo",
        "blog do mario adolfo", "blog do mário adolfo",
        "blog da floresta", "portal da marcela rosa",
        "portal do generoso", "rede tiradentes",
    ],
